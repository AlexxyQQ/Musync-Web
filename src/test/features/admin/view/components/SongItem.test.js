import "@testing-library/jest-dom/extend-expect"; // Importing the extend-expect matchers
import { render, screen } from "@testing-library/react";
import SongItem from "../../../../../features/admin/view/components/SongItem";
...
test("renders the SongItem component with mock data", () => {
  // mock data for a song
  const songs = mockSongs;

  render(<SongItem allUsers={songs} />);

  expect(screen.getAllByText("Kind of Sick of Life")[0]).toBeInTheDocument();
});
